# Linguagens e Ambientes de Programação (Edição 2026)
...
A segunda referência para a unidade curricular é o livro "Programming Languages Pragmatics" de Michael L. Scott e Jonathan Aldrich. O livro está disponível na biblioteca da faculdade e os recursos do livro online podem ser encontrados em [Programming Languages Pragmatics](https://www.cs.rochester.edu/~scott/pragmatics/).
...
O plano tentativo para as aulas será aqui exposto.
...
|10|30/4|[Memoization](slides/pt/aula14.pdf)|||
...
|11|P|| [Exercícios: Pairing Heap Modular](praticas/pt/lab9/lab9_functor_pairing_heap.ipynb)
